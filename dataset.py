...
def make_seq2seq_data(tokenizer, dir_path, max_len):
    ...
    for file_name in file_progress_bar:
        ...
        for line in tqdm(data_file,
                         ...
                         position=1, leave=True):
            line = line[:-1]
            line_ids = tokenizer.encode(line, add_special_tokens=False, pad_to_max_length=False, max_length=max_len,
                                        truncation=True)
...
if __name__ == '__main__':
    data_path = ''
    tokenizer = BertTokenizer('bert-base-uncased-vocab.txt', do_lower_case=False)
