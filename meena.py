...
from transformer import PositionalEmbedding, Encoder, Decoder
...
class MeenaEncoder(nn.Module):
    def __init__(self,
        ...
        self.encoders = nn.ModuleList(
            [Encoder(d_model=dim, head_num=head_num, dropout=dropout) for _ in range(encoder_depth)])
...
class MeenaDecoder(nn.Module):
    def __init__(self,
        ...
        self.decoders = nn.ModuleList(
            [Decoder(d_model=dim, head_num=head_num, dropout=dropout) for _ in range(decoder_depth)])
